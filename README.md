# Modifications for Rloops
Specify additional tracks in the dataspec like this: 
```yaml
fasta_file: /Users/albertstanley/Code/quonlab/data/hg19.fa  # using subset
added_track_dict:
  avgG:
    path: '/Users/albertstanley/Code/quonlab/data/additional/avgG.bw' 
  bpprob:
    path: '/Users/albertstanley/Code/quonlab/data/additional/bpprob.bw'
task_specs: 
  rep1:
    tracks:
      - /Users/albertstanley/Code/quonlab/data/dripc/rep1/plus.bw
      - /Users/albertstanley/Code/quonlab/data/dripc/rep1/minus.bw
    peaks: /Users/albertstanley/Code/quonlab/tests/test1/simple.bed
```
- Use rloop as premade model in ```bpnet train --premade=rloop```
- Make sure to set **num_channels** to match total number of channels ( including/excluding dna) specified in the dataspec
- Set **exclude_dna** if you need to exclude dna
